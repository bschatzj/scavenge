...
export default function Emailer(props) {
    ...
    useEffect(() => {
        ...
        If you would like to join please make an account at http://scavengewithfriends.com/register Then this link is to the game http://scavengewithfriends.com${(location.pathname.replace(' ', '%20').replace(' ', '%20').replace(' ', '%20'))} ${"\n"}
